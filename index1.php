...
<!-- <div class="header-1">
    ...
    <a href="index.php" class="logo" > <img src="website/all/tealogo.png" alt="Logo image" class="hidden-xs">  </a>
...
<a id="pr" href="#"> Shopping Cart Total Price: CNY <?php totalPrice(); ?>, Total Items <?php item(); ?></a>
</div>
  ...
  <footer class="footer" id="footer">
     <div class="cuntainer">
        <div class="wolf">
            ...
            <p class="credit">Created By <span>Mohammed Mouafik</span></p>
        </div>
     </div>
  </footer>
