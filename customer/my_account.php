...
.logout:hover {
   ...
   <body>
                  ...
                  <div class="login_text">
                     <ul>
                        ...
                        <?php
                           ...
                           echo "<li><a href='my_account.php?my_order'><img src='../images/user-icon.png'></a></li>";
      ...
      <div class="profile-container">
              ...
              <?php
                ...
                if (!isset($_SESSION['customer_email'])){
                  ...
                  <div class='profile-image'>
                    <img src='customer_images/$customer_image' alt='Profile Picture'>
                  </div>
        ...
        <div class="profile-body">
          <div class="profile-actions">
            <a href="my_account.php?my_order" class="profile-button">My Orders</a>
            <a href="my_account.php?pay_offline" class="profile-button">Pay Online</a>
            <a href="my_account.php?edit_act" class="profile-button">Edit Account</a>
            <a href="my_account.php?change_pass" class="profile-button">Change Password</a>
            <a href="my_account.php?delete_ac" class="profile-button delete-account">Delete Account</a>
            <a href="../logout.php" class="profile-button logout">Logout</a>
          </div>
      ...
      <div class="footer_section layout_padding">
         <div class="container">
            <div class="footer_logo"><a href="index.html"><img src="i../images/footer-logo.png"></a></div>
