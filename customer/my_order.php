     	...
     	<table class="tab">
     		...
     		<tbody>
     			...
     			<tr>
     				...
     				<td>
						<?php if('pending'==$row_order['order_status']){?>
						<a href="confirm.php?order_id=<?php echo $order_id ?>" target="_blank" class="btn btn-primary btn-sm">confirm Now</a>
						<?php }else { echo "Order Paid"; }?>
